...
\begin{tikzpicture}
\node (img1)  {\includegraphics[width=6cm]{pics/Kompliziert.jpg} };
\onslide+<2->{
\node (img2) at (img1.south east) [yshift=0.5cm,xshift=2cm] {\includegraphics[width=6cm]{pics/Formeln.jpg}};
}
\onslide+<3->{
\node (img3) at (img2.south west) [xshift=-1cm] {\includegraphics[width=6cm]{pics/Namen.jpg}};
}
\end{tikzpicture}
